      ...
      <div className="text-center max-w-4xl">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-bold mb-4">
            {"TAPAS KUMAR".split("").map((letter, index) => (
              <motion.span
                key={index}
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <div className="text-lg text-gray-400">AI Engineer | Architecting Production ML Systems</div>
          <div className="text-blue-400">LLM Systems • Computer Vision • Deep Learning • MLOps</div>
        </motion.div>
      </div>
    </section>
  );
