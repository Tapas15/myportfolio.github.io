            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { icon: Github, label: "GitHub Profile", href: "https://github.com/tapaskumar", color: "from-gray-400 to-gray-600" },
                  { icon: Linkedin, label: "LinkedIn Profile", href: "https://www.linkedin.com/in/tapaskumar", color: "from-blue-400 to-blue-600" }
                ].map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
